...
public class EnviarEmail {
    ...
    private String emailRemetente = new Config().email;
    private String senhaEmail = new Config().senhaEmail;
    ...
    public boolean enviar() {
        ...
        if(new Config().tipoEmail.equals("gmail") ){
        ...
        Session s = Session.getDefaultInstance(props,
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication(emailRemetente, senhaEmail);//email e senha usuário 
            }
        });
